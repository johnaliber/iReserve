                ...
                <table role="presentation" cellspacing="0" cellpadding="0" style="margin:24px auto 0;">
                  <tr>
                    <td style="border-radius:999px;background:#00a876;">
                      <a href="${escapeHtml(destination)}" style="display:inline-block;padding:12px 24px;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;">Open iReserve</a>
                    </td>
                  </tr>
                </table>
                <p style="margin:22px 0 0;color:#64748b;font-size:12px;line-height:1.6;">Log in to your iReserve account to view complete details.</p>
              </td>
            </tr>
            <tr>
